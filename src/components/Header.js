...
const Header = () => {
    ...
    console.log("What i got as cart items::", cartItems)
        ...
        <div className='flex h-24 justify-between bg-gradient-to-r from-rose-500 to-pink-500  text-white'>
            ...
            <div className='nav-items'>
                <ul className='flex pt-12 pr-16'>
                    ...
                    <li><Link to="/cart" className='hyperlink px-2'><i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart -  {cartItems.length>0? cartItems.length: cartItems.length}</Link></li>
